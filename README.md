...
Após iniciar a aplicação, acesse o **Swagger UI** para explorar os endpoints, visualizar os modelos de dados e testar as requisições diretamente pelo navegador.
